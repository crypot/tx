...
import com.exc.config.ConstStrings;
import com.exc.domain.CurrencyName;
import com.exc.service.error.BalanceLockException;
...
public class WalletSyncService {
    ...
    private String getKey(Long userId, CurrencyName curId, boolean isLock) {
        ...
        if (isLock)
            builder.append(ConstStrings.BALANCE_SYNC_LOCK_KEY);
        else builder.append(ConstStrings.BALANCE_SYNC_KEY);
     ...
     */
    public boolean modBalance(CurrencyName currencyName, Long userId, BigInteger lockSum, boolean isCredit) throws InterruptedException {
